      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              <span className="text-2xl font-bold" style={{ color: theme?.colors?.primary || '#2563eb' }}>
                {t('site.name', 'Cobalt Hosting')}
              </span>
            </div>
            <p className="text-gray-400 text-base">
              {t('footer.tagline', 'Powering your online presence with reliable and scalable hosting solutions.')}
            </p>
                ...
                <ul className="mt-4 space-y-4">
                  {footerLinks.company.map((item) => (
                    <li key={item.name}>
                      ...
                      >
                        {t(item.name, item.name.split('.').pop())}
                      </Link>
                    </li>
                  ))}
                </ul>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {currentYear} {t('site.name', 'Cobalt Hosting')}. {t('footer.rights', 'All rights reserved.')}
          </p>
        </div>
      </div>
    </footer>
